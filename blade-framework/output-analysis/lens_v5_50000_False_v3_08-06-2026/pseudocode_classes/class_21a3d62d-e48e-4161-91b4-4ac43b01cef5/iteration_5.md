...
class Optimizer:
    ...
    def __call__(self, func, grad_func=None, hess_func=None, **kwargs):
        ...
        //     [VAR_50] += 1
        //     [VAR_51] = np.empty_like(pop)
        //     [VAR_52] = np.empty([VAR_46])
        //     
        //     FOR [VAR_13] FROM 0 TO [VAR_46] - 1 DO
        ...
        //         ENDIF
        //         
        //         IF [VAR_70] < [VAR_52][[VAR_28]]
        //             THEN
        //                 [VAR_52][[VAR_28]] = [VAR_70]
        //                 pop[[VAR_28]] = [VAR_69]
        //         ENDIF
        //     ENDIF
        // 
        //     [VAR_48] = [OP_BOUND]([VAR_48] * 1.05, INTEGER, INTEGER)
        //     [VAR_49] = [OP_BOUND]([VAR_49] + 0.01, INTEGER, INTEGER)
        // ENDWHILE
        // ```
        // :::END_PSEUDOCODE:::
