...
CLASS Optimizer
    ...
    // Pseudocode for __init__ [VAR_58]
    ...
    // END Pseudocode for __init__ [VAR_58]
    ...
    FUNCTION __call__(self, [VAR_6], [VAR_49]=None, [VAR_20]=None, **[VAR_21])
        pop = np.[VAR_26].uniform(-1, 1, size=(20, self.[VAR_4]))
        [VAR_50] = []
    ...
    RETURN self.[VAR_44], self.[VAR_45]
