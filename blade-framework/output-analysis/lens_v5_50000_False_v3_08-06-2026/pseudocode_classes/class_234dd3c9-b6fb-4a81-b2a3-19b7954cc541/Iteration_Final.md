...
CLASS Optimizer
    ...
    //     //             SET [VAR_95] TO np.[VAR_26].[VAR_26].randint(0, [VAR_88])
    //     //         END WHILE
    //     //         WHILE [VAR_96] == [VAR_27] OR [VAR_96] == [VAR_95] DO
    //     //             SET [VAR_96] TO np.[VAR_26].[VAR_26].randint(0, [VAR_88])
    //     //         END WHILE
    //     //         WHILE [VAR_97] == [VAR_27] OR [VAR_97] == [VAR_95] OR [VAR_97] == [VAR_96] DO
    //     //             SET [VAR_97] TO np.[VAR_26].[VAR_26].randint(0, [VAR_88])
    //     //         END WHILE
    // 
    //     //         SET [VAR_98] TO COPY(pop[[VAR_95]])
    //     //         SET [VAR_98][18:24] = np.[VAR_26].[VAR_26].permutation([VAR_98][18:24])
    //     // 
    //     //         SET [VAR_99] TO COPY(pop[[VAR_96]])
    //     //         SET [VAR_99][18:24] = np.[VAR_26].[VAR_26].permutation([VAR_99][18:24])
    //     // 
    //     //         SET [VAR_100] TO COPY(pop[[VAR_97]])
    //     //         SET [VAR_100][18:24] = np.[VAR_26].[VAR_26].permutation([VAR_100][18:24])
    // 
